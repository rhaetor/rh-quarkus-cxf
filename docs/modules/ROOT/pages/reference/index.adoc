...
| Via `com.sun.xml.fastinfoset:FastInfoset` dependency. Allows CXF endpoints and clients to exchange binary messages encoded in FastInfoset format. This use case only has community support.
